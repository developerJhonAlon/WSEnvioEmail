...
public class EnvioMailThread extends Thread {
    ...
    public void run() {
        ...
        try {
            ...
            InitialContext ic = new InitialContext();
            Session session = (Session) ic.lookup("mail/MySession2");//Variable creada en Glassfish>JavaEmail Sessions
            Properties props = session.getProperties();
//            props.put("mail.smtp.host","10.1.1.116");
//            props.put("mail.smtp.port",25);
//            props.put("mail.transport.protocol","smtp");
//            props.put("mail.smtp.auth", "false");//No requiere autentificacion
//            
            Message msg = new MimeMessage(session);
            msg.setSubject(asunto);
            msg.setSentDate(new Date());
